...
{
    public partial class movetarget : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    {
                        if (Session["MoveTargetCode"] == null)
                            Session.Add("MoveTargetCode", Request.QueryString["Code"]);
                        else
                            Session["MoveTargetCode"] = Request.QueryString["Code"];

                        if (Session["MoveTargetCode"].ToString().Length != 64)
                        {
                        ...
                        {
                            DataTable dtResult = GF.GetCentralDatav7(53785378, "f833571d0d6374694d320f4ceacfc2fae860f2364133cde29d4a09c56a4efd58", CentralCommsv7.DatabaseCommand.GlobalAccess_UsersCheckUpdateEmailVerification, Session["MoveTargetCode"].ToString());
                ...
                {
                    GFS.LogError(eee, GeneralFunctions.EventLogEntryType.Error, 26060659);
                }
            }
        }
        ...
        private void BtnUpdateEmail_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dtResult = GF.GetCentralDatav7(53785378, "f833571d0d6374694d320f4ceacfc2fae860f2364133cde29d4a09c56a4efd58", CentralCommsv7.DatabaseCommand.GlobalAccess_UsersDoUpdateEmailVerification, Session["MoveTargetCode"].ToString());
            ...
            {
                GFS.LogError(eee, GeneralFunctions.EventLogEntryType.Error, 26060660);
            }
        }
    }
}