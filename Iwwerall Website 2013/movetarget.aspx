<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="movetarget.aspx.cs" Inherits="Iwwerall_Website_2013.movetarget" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="container-fluid d-flex justify-content-center align-items-center w-100">
        <div class="container p-3 m-1 p-md-5 m-md-5 card verification-container">
            <div class="row">
                <div class="col-sm">
                    <asp:Image runat="server" ImageUrl="~/Images/iwwerall-movetarget.svg" CssClass="image-display" />
                </div>
